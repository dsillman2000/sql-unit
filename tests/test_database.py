...
class TestConnectionConfig:
    ...
    def test_mysql_config(self):
        ...
        config = ConnectionConfig.mysql(
            host="localhost", port=3306, database="testdb", user="admin", password="secret"
        )
    ...
    def test_from_yaml_sqlite(self):
        ...
        config_dict = {"type": "sqlite", "path": ":memory:"}
...
class TestConnectionConfigFactory:
    ...
    def test_config_with_options(self):
        ...
        config = ConnectionConfig.sqlite(":memory:", echo=True, pool_size=20)
        assert config.kwargs.get("echo") is True
