with lineitem_table as (
    select
        cast(null as string) as l_returnflag,
        cast(null as string) as l_linestatus,
        cast(null as int) as l_quantity,
        cast(null as float) as l_extendedprice,
        cast(null as float) as l_discount,
        cast(null as float) as l_tax,
