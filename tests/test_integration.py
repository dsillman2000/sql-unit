...
SELECT 42 as result;
    ...
    def test_error_handling_in_pipeline(self):
        ...
        test = TestDefinition(
            name="test_bad_statement", given={}, expect={}, filepath="test.sql", line_number=1
        )
...
class TestStatementValidationInContext:
    ...
    def test_reject_insert_with_test(self):
        ...
        test = TestDefinition(name="test_insert", filepath="test.sql", line_number=1)
    ...
    def test_accept_select_with_test(self):
        ...
        test = TestDefinition(name="test_select", filepath="test.sql", line_number=1)
...
class TestRendererInContext:
    ...
    def test_error_undefined_variable_in_context(self):
        ...
        test = TestDefinition(name="test_missing_var", given={}, filepath="test.sql", line_number=1)
