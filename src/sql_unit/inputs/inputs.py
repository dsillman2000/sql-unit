...
class GivenClauseParser:
    ...
    def _parse_cte_input(cte_spec: dict[str, Any]) -> InputSpec:
        ...
        return InputSpec(
            input_type=InputType.CTE, targets=targets, data_source=data_source, alias=alias
        )
    ...
    def _parse_relation_input(relation_spec: dict[str, Any]) -> InputSpec:
        ...
        return InputSpec(input_type=InputType.RELATION, targets=targets, replacement=replacement)
    ...
    def _parse_jinja_context_input(jinja_spec: dict[str, Any]) -> InputSpec:
        ...
        return InputSpec(input_type=InputType.JINJA_CONTEXT, jinja_context=jinja_spec)
