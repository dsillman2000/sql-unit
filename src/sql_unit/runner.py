...
class TestRunner:
    ...
    def run_test(self, test: TestDefinition, statement_sql: str) -> TestResult:
        ...
        try:
            ...
            return TestResult(test_id=test_id, passed=True, duration=duration)
            ...
            return TestResult(test_id=test_id, passed=False, duration=duration, error=error_report)
    ...
    def _render_sql(self, sql: str, test_id: str, context: dict[str, Any]) -> str:
        """
...
class BatchTestRunner:
    ...
    def run_tests(self, tests: list[TestDefinition], statements: list[str]) -> list[TestResult]:
        """
        Run multiple tests.
