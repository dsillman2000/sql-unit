...
This specification defines the configuration system for SQL Unit, including support for sql-unit.yaml configuration files, database connection management, test path configuration, execution defaults, and CLI integration for configuration-free execution.
