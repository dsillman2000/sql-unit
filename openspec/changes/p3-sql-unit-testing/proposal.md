...
Phases 1 and 2 implement the full SQL Unit testing framework with core execution, inputs, expectations, CLI, and configuration. Phase 3 focuses on the sql-unit library itself - a comprehensive test suite ensuring reliability and correctness. This phase tests:
- Core parser and renderer
- Input setup (CTE, relation)
